(function () {
    version.extensions.replaceMacrosCombined = { major: 1, minor: 1, revision: 6 };
    var nullobj = { handler() {} };
    function showVer(n, notrans) {
        ...
        n.innerHTML = '';
        new Wikifier(n, n.tweecode, true);
    ...
    function timeSetup(m, g, f) {
        ...
        var s = state.history[0].passage.title;
    ...
    function hoverSetup(m) {
        var fn,
            noMouseEnter = (document.head.onmouseenter !== null),
            m1 = m.children[0],
            m2 = m.children[1],
            gains = m2.className.indexOf('gains') > -1;
        if (!m1 || !m2) {
            return;
        }
    ...
    macros.revert = macros.revise = macros.randomise = macros.randomize = { handler(a, b, c) {
        var l,
            rev,
            rname;
        ...
        function updateLink(l) {
            ...
            for (i = 0; i < rall.length; i++) {
                ...
                if (fl == 'cycle') {
                    ...
                    if (r.lastChild.getAttribute('data-enabled') == String(!1)) {
                        cannext = true;
                    }
                }
            }
        ...
        switch (c[c.length - 1]) {
            case 'end': end = true; c.pop(); break;
            case 'out': out = true; c.pop(); break;
        }
    ...
    macros.mouserevise = macros.hoverrevise = { handler(a, b, c, d) {
        var endtags = [ `end${ b }` ],
    ...
    macros.instantrevise = { handler(a, b, c, d) {
